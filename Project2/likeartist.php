...
<body>
	<div class="d01">
		...
		$artisttitle1=$artisttitle;	
		$artisttitle = pg_escape_string($artisttitle);

		$querytest="select artisttitle from artist where artisttitle='$artisttitle' or artisttitle='$artisttitle1'";
		$resulttest=pg_query($querytest);
		if(pg_fetch_result($resulttest, 0, 0)<>$artisttitle){
			echo '<div class="temp1">';
			echo "<h3>Sorry, can't find this artist!</h3>";
		...
		$querylike="insert into likeartist (username, artisttitle,likedate)values('$username','$artisttitle','$likedate');";
		$resultlike=pg_query($querylike) or die('Query failed: ' . pg_last_error());
