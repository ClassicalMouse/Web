...
<body>
	<div class="d01">
		...
		<div class='d02'>";
			...
			$querytest="select trackid from playlist natural join users natural join playlisttrack where username='$guest' and pid='$pid' and trackid='$trackid'";
			        	...
			        	while($line1 = pg_fetch_array($result1, null, PGSQL_ASSOC)){
			        		...
			        		foreach ($line1 as $col_value1) {
						        ...
						        if($j==3){
									...
									echo '<input name="username" type="hidden" value="';echo $guest;echo '">';
									echo '<input name="upassword" type="hidden" value="';echo $upassword;echo '">';
									echo '<input name="artisttitle" type="hidden" value="';echo $col_value1;echo '">';
									echo '</form>';
						        	...
						        	echo '</td>';*/
						        	$query3="select ptittle, pid from playlist where username='$guest'";
						        	...
						        	echo '<td><li class="dropdown">
							                ...
							                while ($line3 = pg_fetch_array($result3, null, PGSQL_ASSOC)) {
											    ...
											    foreach ($line3 as $col_value3) {
										            ...
										            echo '<form id="addplaylist';echo $a,$k,$d;echo '" action="followaddplaylist.php" method = "post">
													<input name="username" type="hidden" value="';
													echo $guest;
													echo '">

													<input name="fusername" type="hidden" value="';
													echo $username;
													echo '">
