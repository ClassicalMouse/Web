...
<body>
	<div class="d01">
		...
		$querytest="select artisttitle from artist where artisttitle='$artisttitle'";
		...
		$querylike="delete from likeartist where username = '$username' and artisttitle='$artisttitle';";
