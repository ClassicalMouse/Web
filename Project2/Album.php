...
<body>
	<div class="d01">
		<?php
			...
			$albumname=$_POST["gotoalbum"];
			$albumid=$_POST["gotoalbum2"];
			echo "<div class='menu'>
		...
		<div class='d02'>";
			...
			$queryx="select llink from albumlink where albumid='$albumid' ";
			...
			if ($bufferx<>null){
				echo '<iframe src="';
				echo $bufferx;
				echo '" width="720" height="500" frameborder="0" allowtransparency="true"></iframe>';

			}
			else{
			
			$escaped = pg_escape_string($albumid);
			$query="select distinct trackname,trackartist,trackid,trackduration
			...
			$j=0;
			echo "<table>\n";
			echo "<tr><th>No</th><th>Track</th><th>Artist</th><th>Duration</th><th>Operation</th></tr>";
			while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
			    ...
			    foreach ($line as $col_value) {
			        ...
			        if($i==1){
			        	echo '<td onclick="';
			        	echo "document.getElementById('artistform"; echo $j;echo "').submit();";echo '" style="cursor: pointer">';echo $col_value;echo '</td>';
			        	echo '<form id="artistform';echo $j;echo'" action="artist.php" method = "post">';
			        ...
			        if($i==3){
		                ...
		                while ($line3 = pg_fetch_array($result3, null, PGSQL_ASSOC)) {
						    ...
						    foreach ($line3 as $col_value3) {
					            ...
					            echo '<form id="addplaylist';echo $j,$d;echo '" action="addplaylistalbum.php" method = "post">
